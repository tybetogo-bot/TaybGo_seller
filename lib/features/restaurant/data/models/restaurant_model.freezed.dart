...
mixin _$RestaurantModel {
 ...
 String get id; String get name; String? get description; String? get phone; String? get email; String? get address; String? get city; String? get country; String? get imageUrl; String? get logoUrl; RestaurantStatus get status; bool get isOpen; String? get openingHours; String? get closingHours; Map<String, List<WorkHourPeriod>> get workHours; bool? get deliveryEnabled; double get deliveryFee; double get minimumOrder; int get estimatedDeliveryTime; List<String> get cuisineTypes; double get rating; int get totalReviews; DateTime? get createdAt; DateTime? get updatedAt;// Today's stats (returned from API)
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RestaurantModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.email, email) || other.email == email)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.country, country) || other.country == country)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.status, status) || other.status == status)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&(identical(other.openingHours, openingHours) || other.openingHours == openingHours)&&(identical(other.closingHours, closingHours) || other.closingHours == closingHours)&&const DeepCollectionEquality().equals(other.workHours, workHours)&&(identical(other.deliveryEnabled, deliveryEnabled) || other.deliveryEnabled == deliveryEnabled)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.minimumOrder, minimumOrder) || other.minimumOrder == minimumOrder)&&(identical(other.estimatedDeliveryTime, estimatedDeliveryTime) || other.estimatedDeliveryTime == estimatedDeliveryTime)&&const DeepCollectionEquality().equals(other.cuisineTypes, cuisineTypes)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.totalReviews, totalReviews) || other.totalReviews == totalReviews)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.todayStats, todayStats) || other.todayStats == todayStats)&&(identical(other.lat, lat) || other.lat == lat)&&(identical(other.lng, lng) || other.lng == lng)&&(identical(other.addressData, addressData) || other.addressData == addressData));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,phone,email,address,city,country,imageUrl,logoUrl,status,isOpen,openingHours,closingHours,const DeepCollectionEquality().hash(workHours),deliveryEnabled,deliveryFee,minimumOrder,estimatedDeliveryTime,const DeepCollectionEquality().hash(cuisineTypes),rating,totalReviews,createdAt,updatedAt,todayStats,lat,lng,addressData]);

@override
String toString() {
  return 'RestaurantModel(id: $id, name: $name, description: $description, phone: $phone, email: $email, address: $address, city: $city, country: $country, imageUrl: $imageUrl, logoUrl: $logoUrl, status: $status, isOpen: $isOpen, openingHours: $openingHours, closingHours: $closingHours, workHours: $workHours, deliveryEnabled: $deliveryEnabled, deliveryFee: $deliveryFee, minimumOrder: $minimumOrder, estimatedDeliveryTime: $estimatedDeliveryTime, cuisineTypes: $cuisineTypes, rating: $rating, totalReviews: $totalReviews, createdAt: $createdAt, updatedAt: $updatedAt, todayStats: $todayStats, lat: $lat, lng: $lng, addressData: $addressData)';
}
...
@useResult
$Res call({
 String id, String name, String? description, String? phone, String? email, String? address, String? city, String? country, String? imageUrl, String? logoUrl, RestaurantStatus status, bool isOpen, String? openingHours, String? closingHours, Map<String, List<WorkHourPeriod>> workHours, bool? deliveryEnabled, double deliveryFee, double minimumOrder, int estimatedDeliveryTime, List<String> cuisineTypes, double rating, int totalReviews, DateTime? createdAt, DateTime? updatedAt, RestaurantStats? todayStats, double? lat, double? lng, RestaurantAddressModel? addressData
});
...
as String?,workHours: null == workHours ? _self.workHours : workHours // ignore: cast_nullable_to_non_nullable
as Map<String, List<WorkHourPeriod>>,deliveryEnabled: freezed == deliveryEnabled ? _self.deliveryEnabled : deliveryEnabled // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _RestaurantModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.phone,_that.email,_that.address,_that.city,_that.country,_that.imageUrl,_that.logoUrl,_that.status,_that.isOpen,_that.openingHours,_that.closingHours,_that.workHours,_that.deliveryEnabled,_that.deliveryFee,_that.minimumOrder,_that.estimatedDeliveryTime,_that.cuisineTypes,_that.rating,_that.totalReviews,_that.createdAt,_that.updatedAt,_that.todayStats,_that.lat,_that.lng,_that.addressData);case _:
  return orElse();
...
class _RestaurantModel implements RestaurantModel {
  const _RestaurantModel({required this.id, required this.name, this.description, this.phone, this.email, this.address, this.city, this.country, this.imageUrl, this.logoUrl, this.status = RestaurantStatus.pending, this.isOpen = false, this.openingHours, this.closingHours, final  Map<String, List<WorkHourPeriod>> workHours = const {}, this.deliveryEnabled, this.deliveryFee = 0.0, this.minimumOrder = 0.0, this.estimatedDeliveryTime = 30, final  List<String> cuisineTypes = const [], this.rating = 0.0, this.totalReviews = 0, this.createdAt, this.updatedAt, this.todayStats, this.lat, this.lng, this.addressData}): _workHours = workHours,_cuisineTypes = cuisineTypes;
...
@override final  String? closingHours;
 final  Map<String, List<WorkHourPeriod>> _workHours;
@override@JsonKey() Map<String, List<WorkHourPeriod>> get workHours {
  if (_workHours is EqualUnmodifiableMapView) return _workHours;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_workHours);
}

@override final  bool? deliveryEnabled;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RestaurantModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.email, email) || other.email == email)&&(identical(other.address, address) || other.address == address)&&(identical(other.city, city) || other.city == city)&&(identical(other.country, country) || other.country == country)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.status, status) || other.status == status)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&(identical(other.openingHours, openingHours) || other.openingHours == openingHours)&&(identical(other.closingHours, closingHours) || other.closingHours == closingHours)&&const DeepCollectionEquality().equals(other._workHours, _workHours)&&(identical(other.deliveryEnabled, deliveryEnabled) || other.deliveryEnabled == deliveryEnabled)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.minimumOrder, minimumOrder) || other.minimumOrder == minimumOrder)&&(identical(other.estimatedDeliveryTime, estimatedDeliveryTime) || other.estimatedDeliveryTime == estimatedDeliveryTime)&&const DeepCollectionEquality().equals(other._cuisineTypes, _cuisineTypes)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.totalReviews, totalReviews) || other.totalReviews == totalReviews)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.todayStats, todayStats) || other.todayStats == todayStats)&&(identical(other.lat, lat) || other.lat == lat)&&(identical(other.lng, lng) || other.lng == lng)&&(identical(other.addressData, addressData) || other.addressData == addressData));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,phone,email,address,city,country,imageUrl,logoUrl,status,isOpen,openingHours,closingHours,const DeepCollectionEquality().hash(_workHours),deliveryEnabled,deliveryFee,minimumOrder,estimatedDeliveryTime,const DeepCollectionEquality().hash(_cuisineTypes),rating,totalReviews,createdAt,updatedAt,todayStats,lat,lng,addressData]);
...
as bool,openingHours: freezed == openingHours ? _self.openingHours : openingHours // ignore: cast_nullable_to_non_nullable
as String?,closingHours: freezed == closingHours ? _self.closingHours : closingHours // ignore: cast_nullable_to_non_nullable
as String?,workHours: null == workHours ? _self._workHours : workHours // ignore: cast_nullable_to_non_nullable
as Map<String, List<WorkHourPeriod>>,deliveryEnabled: freezed == deliveryEnabled ? _self.deliveryEnabled : deliveryEnabled // ignore: cast_nullable_to_non_nullable
as bool?,deliveryFee: null == deliveryFee ? _self.deliveryFee : deliveryFee // ignore: cast_nullable_to_non_nullable
as double,minimumOrder: null == minimumOrder ? _self.minimumOrder : minimumOrder // ignore: cast_nullable_to_non_nullable
as double,estimatedDeliveryTime: null == estimatedDeliveryTime ? _self.estimatedDeliveryTime : estimatedDeliveryTime // ignore: cast_nullable_to_non_nullable
