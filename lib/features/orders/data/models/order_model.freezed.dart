...
mixin _$OrderModel {
 ...
 String get id; String get customerName; String get phoneNumber; String get countryCode; AddressModel get address; List<OrderItemModel> get items; double get subtotal; double get deliveryFee; double get discountAmount; double get tips; double get total;/// Server-calculated seller amount; null for legacy orders without a subtotal.
 double? get sellerTotalAmount; bool get isPaid; OrderStatusEnum get status; bool get hasAllowedStatusOptions; List<OrderAllowedStatusOption> get allowedStatusOptions; List<OrderAllowedAction> get allowedActions; String? get notes; String? get rejectionReason; DateTime get createdAt; DateTime? get acceptedAt; DateTime? get readyAt; DateTime? get outForDeliveryAt; DateTime? get deliveredAt; String? get restaurantId; String? get assignedDriverId;// New fields from API
 String get orderType; String? get fulfillmentType; OrderRestaurantModel? get restaurant; OrderCouponModel? get coupon; OrderAddressModel? get pickupAddress; OrderAddressModel? get dropoffAddress; String? get requestedVehicleType; String? get requestedDeliveryType; OrderDriverModel? get driver; bool get isManual;/// Backend-controlled delayed driver-dispatch fields.
///
...
/// been accepted yet do not have an active dispatch schedule.
 DateTime? get driverDispatchDueAt; int? get driverDispatchDelayMinutes; String? get driverDispatchStatus; int? get driverDispatchRemainingSeconds; DateTime? get driverDispatchServerTime; int? get driverDispatchMaxDelayMinutes; bool get supportsPreparationTiming; int? get preparationTimeMinutes; DateTime? get preparationReadyAt; int? get preparationRemainingSeconds; DateTime? get preparationServerTime; int? get preparationMaxMinutes; int? get driverDispatchLeadMinutes;/// Local receipt time for the server clock sample; survives widget remounts.
 DateTime? get timingReceivedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderModel&&(identical(other.id, id) || other.id == id)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.address, address) || other.address == address)&&const DeepCollectionEquality().equals(other.items, items)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.discountAmount, discountAmount) || other.discountAmount == discountAmount)&&(identical(other.tips, tips) || other.tips == tips)&&(identical(other.total, total) || other.total == total)&&(identical(other.sellerTotalAmount, sellerTotalAmount) || other.sellerTotalAmount == sellerTotalAmount)&&(identical(other.isPaid, isPaid) || other.isPaid == isPaid)&&(identical(other.status, status) || other.status == status)&&(identical(other.hasAllowedStatusOptions, hasAllowedStatusOptions) || other.hasAllowedStatusOptions == hasAllowedStatusOptions)&&const DeepCollectionEquality().equals(other.allowedStatusOptions, allowedStatusOptions)&&const DeepCollectionEquality().equals(other.allowedActions, allowedActions)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.rejectionReason, rejectionReason) || other.rejectionReason == rejectionReason)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.acceptedAt, acceptedAt) || other.acceptedAt == acceptedAt)&&(identical(other.readyAt, readyAt) || other.readyAt == readyAt)&&(identical(other.outForDeliveryAt, outForDeliveryAt) || other.outForDeliveryAt == outForDeliveryAt)&&(identical(other.deliveredAt, deliveredAt) || other.deliveredAt == deliveredAt)&&(identical(other.restaurantId, restaurantId) || other.restaurantId == restaurantId)&&(identical(other.assignedDriverId, assignedDriverId) || other.assignedDriverId == assignedDriverId)&&(identical(other.orderType, orderType) || other.orderType == orderType)&&(identical(other.fulfillmentType, fulfillmentType) || other.fulfillmentType == fulfillmentType)&&(identical(other.restaurant, restaurant) || other.restaurant == restaurant)&&(identical(other.coupon, coupon) || other.coupon == coupon)&&(identical(other.pickupAddress, pickupAddress) || other.pickupAddress == pickupAddress)&&(identical(other.dropoffAddress, dropoffAddress) || other.dropoffAddress == dropoffAddress)&&(identical(other.requestedVehicleType, requestedVehicleType) || other.requestedVehicleType == requestedVehicleType)&&(identical(other.requestedDeliveryType, requestedDeliveryType) || other.requestedDeliveryType == requestedDeliveryType)&&(identical(other.driver, driver) || other.driver == driver)&&(identical(other.isManual, isManual) || other.isManual == isManual)&&(identical(other.driverDispatchDueAt, driverDispatchDueAt) || other.driverDispatchDueAt == driverDispatchDueAt)&&(identical(other.driverDispatchDelayMinutes, driverDispatchDelayMinutes) || other.driverDispatchDelayMinutes == driverDispatchDelayMinutes)&&(identical(other.driverDispatchStatus, driverDispatchStatus) || other.driverDispatchStatus == driverDispatchStatus)&&(identical(other.driverDispatchRemainingSeconds, driverDispatchRemainingSeconds) || other.driverDispatchRemainingSeconds == driverDispatchRemainingSeconds)&&(identical(other.driverDispatchServerTime, driverDispatchServerTime) || other.driverDispatchServerTime == driverDispatchServerTime)&&(identical(other.driverDispatchMaxDelayMinutes, driverDispatchMaxDelayMinutes) || other.driverDispatchMaxDelayMinutes == driverDispatchMaxDelayMinutes)&&(identical(other.supportsPreparationTiming, supportsPreparationTiming) || other.supportsPreparationTiming == supportsPreparationTiming)&&(identical(other.preparationTimeMinutes, preparationTimeMinutes) || other.preparationTimeMinutes == preparationTimeMinutes)&&(identical(other.preparationReadyAt, preparationReadyAt) || other.preparationReadyAt == preparationReadyAt)&&(identical(other.preparationRemainingSeconds, preparationRemainingSeconds) || other.preparationRemainingSeconds == preparationRemainingSeconds)&&(identical(other.preparationServerTime, preparationServerTime) || other.preparationServerTime == preparationServerTime)&&(identical(other.preparationMaxMinutes, preparationMaxMinutes) || other.preparationMaxMinutes == preparationMaxMinutes)&&(identical(other.driverDispatchLeadMinutes, driverDispatchLeadMinutes) || other.driverDispatchLeadMinutes == driverDispatchLeadMinutes)&&(identical(other.timingReceivedAt, timingReceivedAt) || other.timingReceivedAt == timingReceivedAt));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,customerName,phoneNumber,countryCode,address,const DeepCollectionEquality().hash(items),subtotal,deliveryFee,discountAmount,tips,total,sellerTotalAmount,isPaid,status,hasAllowedStatusOptions,const DeepCollectionEquality().hash(allowedStatusOptions),const DeepCollectionEquality().hash(allowedActions),notes,rejectionReason,createdAt,acceptedAt,readyAt,outForDeliveryAt,deliveredAt,restaurantId,assignedDriverId,orderType,fulfillmentType,restaurant,coupon,pickupAddress,dropoffAddress,requestedVehicleType,requestedDeliveryType,driver,isManual,driverDispatchDueAt,driverDispatchDelayMinutes,driverDispatchStatus,driverDispatchRemainingSeconds,driverDispatchServerTime,driverDispatchMaxDelayMinutes,supportsPreparationTiming,preparationTimeMinutes,preparationReadyAt,preparationRemainingSeconds,preparationServerTime,preparationMaxMinutes,driverDispatchLeadMinutes,timingReceivedAt]);

@override
String toString() {
  return 'OrderModel(id: $id, customerName: $customerName, phoneNumber: $phoneNumber, countryCode: $countryCode, address: $address, items: $items, subtotal: $subtotal, deliveryFee: $deliveryFee, discountAmount: $discountAmount, tips: $tips, total: $total, sellerTotalAmount: $sellerTotalAmount, isPaid: $isPaid, status: $status, hasAllowedStatusOptions: $hasAllowedStatusOptions, allowedStatusOptions: $allowedStatusOptions, allowedActions: $allowedActions, notes: $notes, rejectionReason: $rejectionReason, createdAt: $createdAt, acceptedAt: $acceptedAt, readyAt: $readyAt, outForDeliveryAt: $outForDeliveryAt, deliveredAt: $deliveredAt, restaurantId: $restaurantId, assignedDriverId: $assignedDriverId, orderType: $orderType, fulfillmentType: $fulfillmentType, restaurant: $restaurant, coupon: $coupon, pickupAddress: $pickupAddress, dropoffAddress: $dropoffAddress, requestedVehicleType: $requestedVehicleType, requestedDeliveryType: $requestedDeliveryType, driver: $driver, isManual: $isManual, driverDispatchDueAt: $driverDispatchDueAt, driverDispatchDelayMinutes: $driverDispatchDelayMinutes, driverDispatchStatus: $driverDispatchStatus, driverDispatchRemainingSeconds: $driverDispatchRemainingSeconds, driverDispatchServerTime: $driverDispatchServerTime, driverDispatchMaxDelayMinutes: $driverDispatchMaxDelayMinutes, supportsPreparationTiming: $supportsPreparationTiming, preparationTimeMinutes: $preparationTimeMinutes, preparationReadyAt: $preparationReadyAt, preparationRemainingSeconds: $preparationRemainingSeconds, preparationServerTime: $preparationServerTime, preparationMaxMinutes: $preparationMaxMinutes, driverDispatchLeadMinutes: $driverDispatchLeadMinutes, timingReceivedAt: $timingReceivedAt)';
}
...
@useResult
$Res call({
 String id, String customerName, String phoneNumber, String countryCode, AddressModel address, List<OrderItemModel> items, double subtotal, double deliveryFee, double discountAmount, double tips, double total, double? sellerTotalAmount, bool isPaid, OrderStatusEnum status, bool hasAllowedStatusOptions, List<OrderAllowedStatusOption> allowedStatusOptions, List<OrderAllowedAction> allowedActions, String? notes, String? rejectionReason, DateTime createdAt, DateTime? acceptedAt, DateTime? readyAt, DateTime? outForDeliveryAt, DateTime? deliveredAt, String? restaurantId, String? assignedDriverId, String orderType, String? fulfillmentType, OrderRestaurantModel? restaurant, OrderCouponModel? coupon, OrderAddressModel? pickupAddress, OrderAddressModel? dropoffAddress, String? requestedVehicleType, String? requestedDeliveryType, OrderDriverModel? driver, bool isManual, DateTime? driverDispatchDueAt, int? driverDispatchDelayMinutes, String? driverDispatchStatus, int? driverDispatchRemainingSeconds, DateTime? driverDispatchServerTime, int? driverDispatchMaxDelayMinutes, bool supportsPreparationTiming, int? preparationTimeMinutes, DateTime? preparationReadyAt, int? preparationRemainingSeconds, DateTime? preparationServerTime, int? preparationMaxMinutes, int? driverDispatchLeadMinutes, DateTime? timingReceivedAt
});
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? customerName = null,Object? phoneNumber = null,Object? countryCode = null,Object? address = null,Object? items = null,Object? subtotal = null,Object? deliveryFee = null,Object? discountAmount = null,Object? tips = null,Object? total = null,Object? sellerTotalAmount = freezed,Object? isPaid = null,Object? status = null,Object? hasAllowedStatusOptions = null,Object? allowedStatusOptions = null,Object? allowedActions = null,Object? notes = freezed,Object? rejectionReason = freezed,Object? createdAt = null,Object? acceptedAt = freezed,Object? readyAt = freezed,Object? outForDeliveryAt = freezed,Object? deliveredAt = freezed,Object? restaurantId = freezed,Object? assignedDriverId = freezed,Object? orderType = null,Object? fulfillmentType = freezed,Object? restaurant = freezed,Object? coupon = freezed,Object? pickupAddress = freezed,Object? dropoffAddress = freezed,Object? requestedVehicleType = freezed,Object? requestedDeliveryType = freezed,Object? driver = freezed,Object? isManual = null,Object? driverDispatchDueAt = freezed,Object? driverDispatchDelayMinutes = freezed,Object? driverDispatchStatus = freezed,Object? driverDispatchRemainingSeconds = freezed,Object? driverDispatchServerTime = freezed,Object? driverDispatchMaxDelayMinutes = freezed,Object? supportsPreparationTiming = null,Object? preparationTimeMinutes = freezed,Object? preparationReadyAt = freezed,Object? preparationRemainingSeconds = freezed,Object? preparationServerTime = freezed,Object? preparationMaxMinutes = freezed,Object? driverDispatchLeadMinutes = freezed,Object? timingReceivedAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as double,sellerTotalAmount: freezed == sellerTotalAmount ? _self.sellerTotalAmount : sellerTotalAmount // ignore: cast_nullable_to_non_nullable
as double?,isPaid: null == isPaid ? _self.isPaid : isPaid // ignore: cast_nullable_to_non_nullable
as bool,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as OrderStatusEnum,hasAllowedStatusOptions: null == hasAllowedStatusOptions ? _self.hasAllowedStatusOptions : hasAllowedStatusOptions // ignore: cast_nullable_to_non_nullable
as bool,allowedStatusOptions: null == allowedStatusOptions ? _self.allowedStatusOptions : allowedStatusOptions // ignore: cast_nullable_to_non_nullable
as List<OrderAllowedStatusOption>,allowedActions: null == allowedActions ? _self.allowedActions : allowedActions // ignore: cast_nullable_to_non_nullable
as List<OrderAllowedAction>,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
...
as String,fulfillmentType: freezed == fulfillmentType ? _self.fulfillmentType : fulfillmentType // ignore: cast_nullable_to_non_nullable
...
as bool,driverDispatchDueAt: freezed == driverDispatchDueAt ? _self.driverDispatchDueAt : driverDispatchDueAt // ignore: cast_nullable_to_non_nullable
as DateTime?,driverDispatchDelayMinutes: freezed == driverDispatchDelayMinutes ? _self.driverDispatchDelayMinutes : driverDispatchDelayMinutes // ignore: cast_nullable_to_non_nullable
as int?,driverDispatchStatus: freezed == driverDispatchStatus ? _self.driverDispatchStatus : driverDispatchStatus // ignore: cast_nullable_to_non_nullable
as String?,driverDispatchRemainingSeconds: freezed == driverDispatchRemainingSeconds ? _self.driverDispatchRemainingSeconds : driverDispatchRemainingSeconds // ignore: cast_nullable_to_non_nullable
as int?,driverDispatchServerTime: freezed == driverDispatchServerTime ? _self.driverDispatchServerTime : driverDispatchServerTime // ignore: cast_nullable_to_non_nullable
as DateTime?,driverDispatchMaxDelayMinutes: freezed == driverDispatchMaxDelayMinutes ? _self.driverDispatchMaxDelayMinutes : driverDispatchMaxDelayMinutes // ignore: cast_nullable_to_non_nullable
as int?,supportsPreparationTiming: null == supportsPreparationTiming ? _self.supportsPreparationTiming : supportsPreparationTiming // ignore: cast_nullable_to_non_nullable
as bool,preparationTimeMinutes: freezed == preparationTimeMinutes ? _self.preparationTimeMinutes : preparationTimeMinutes // ignore: cast_nullable_to_non_nullable
as int?,preparationReadyAt: freezed == preparationReadyAt ? _self.preparationReadyAt : preparationReadyAt // ignore: cast_nullable_to_non_nullable
as DateTime?,preparationRemainingSeconds: freezed == preparationRemainingSeconds ? _self.preparationRemainingSeconds : preparationRemainingSeconds // ignore: cast_nullable_to_non_nullable
as int?,preparationServerTime: freezed == preparationServerTime ? _self.preparationServerTime : preparationServerTime // ignore: cast_nullable_to_non_nullable
as DateTime?,preparationMaxMinutes: freezed == preparationMaxMinutes ? _self.preparationMaxMinutes : preparationMaxMinutes // ignore: cast_nullable_to_non_nullable
as int?,driverDispatchLeadMinutes: freezed == driverDispatchLeadMinutes ? _self.driverDispatchLeadMinutes : driverDispatchLeadMinutes // ignore: cast_nullable_to_non_nullable
as int?,timingReceivedAt: freezed == timingReceivedAt ? _self.timingReceivedAt : timingReceivedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
/// Create a copy of OrderModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String customerName,  String phoneNumber,  String countryCode,  AddressModel address,  List<OrderItemModel> items,  double subtotal,  double deliveryFee,  double discountAmount,  double tips,  double total,  double? sellerTotalAmount,  bool isPaid,  OrderStatusEnum status,  bool hasAllowedStatusOptions,  List<OrderAllowedStatusOption> allowedStatusOptions,  List<OrderAllowedAction> allowedActions,  String? notes,  String? rejectionReason,  DateTime createdAt,  DateTime? acceptedAt,  DateTime? readyAt,  DateTime? outForDeliveryAt,  DateTime? deliveredAt,  String? restaurantId,  String? assignedDriverId,  String orderType,  String? fulfillmentType,  OrderRestaurantModel? restaurant,  OrderCouponModel? coupon,  OrderAddressModel? pickupAddress,  OrderAddressModel? dropoffAddress,  String? requestedVehicleType,  String? requestedDeliveryType,  OrderDriverModel? driver,  bool isManual,  DateTime? driverDispatchDueAt,  int? driverDispatchDelayMinutes,  String? driverDispatchStatus,  int? driverDispatchRemainingSeconds,  DateTime? driverDispatchServerTime,  int? driverDispatchMaxDelayMinutes,  bool supportsPreparationTiming,  int? preparationTimeMinutes,  DateTime? preparationReadyAt,  int? preparationRemainingSeconds,  DateTime? preparationServerTime,  int? preparationMaxMinutes,  int? driverDispatchLeadMinutes,  DateTime? timingReceivedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
return $default(_that.id,_that.customerName,_that.phoneNumber,_that.countryCode,_that.address,_that.items,_that.subtotal,_that.deliveryFee,_that.discountAmount,_that.tips,_that.total,_that.sellerTotalAmount,_that.isPaid,_that.status,_that.hasAllowedStatusOptions,_that.allowedStatusOptions,_that.allowedActions,_that.notes,_that.rejectionReason,_that.createdAt,_that.acceptedAt,_that.readyAt,_that.outForDeliveryAt,_that.deliveredAt,_that.restaurantId,_that.assignedDriverId,_that.orderType,_that.fulfillmentType,_that.restaurant,_that.coupon,_that.pickupAddress,_that.dropoffAddress,_that.requestedVehicleType,_that.requestedDeliveryType,_that.driver,_that.isManual,_that.driverDispatchDueAt,_that.driverDispatchDelayMinutes,_that.driverDispatchStatus,_that.driverDispatchRemainingSeconds,_that.driverDispatchServerTime,_that.driverDispatchMaxDelayMinutes,_that.supportsPreparationTiming,_that.preparationTimeMinutes,_that.preparationReadyAt,_that.preparationRemainingSeconds,_that.preparationServerTime,_that.preparationMaxMinutes,_that.driverDispatchLeadMinutes,_that.timingReceivedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String customerName,  String phoneNumber,  String countryCode,  AddressModel address,  List<OrderItemModel> items,  double subtotal,  double deliveryFee,  double discountAmount,  double tips,  double total,  double? sellerTotalAmount,  bool isPaid,  OrderStatusEnum status,  bool hasAllowedStatusOptions,  List<OrderAllowedStatusOption> allowedStatusOptions,  List<OrderAllowedAction> allowedActions,  String? notes,  String? rejectionReason,  DateTime createdAt,  DateTime? acceptedAt,  DateTime? readyAt,  DateTime? outForDeliveryAt,  DateTime? deliveredAt,  String? restaurantId,  String? assignedDriverId,  String orderType,  String? fulfillmentType,  OrderRestaurantModel? restaurant,  OrderCouponModel? coupon,  OrderAddressModel? pickupAddress,  OrderAddressModel? dropoffAddress,  String? requestedVehicleType,  String? requestedDeliveryType,  OrderDriverModel? driver,  bool isManual,  DateTime? driverDispatchDueAt,  int? driverDispatchDelayMinutes,  String? driverDispatchStatus,  int? driverDispatchRemainingSeconds,  DateTime? driverDispatchServerTime,  int? driverDispatchMaxDelayMinutes,  bool supportsPreparationTiming,  int? preparationTimeMinutes,  DateTime? preparationReadyAt,  int? preparationRemainingSeconds,  DateTime? preparationServerTime,  int? preparationMaxMinutes,  int? driverDispatchLeadMinutes,  DateTime? timingReceivedAt)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
return $default(_that.id,_that.customerName,_that.phoneNumber,_that.countryCode,_that.address,_that.items,_that.subtotal,_that.deliveryFee,_that.discountAmount,_that.tips,_that.total,_that.sellerTotalAmount,_that.isPaid,_that.status,_that.hasAllowedStatusOptions,_that.allowedStatusOptions,_that.allowedActions,_that.notes,_that.rejectionReason,_that.createdAt,_that.acceptedAt,_that.readyAt,_that.outForDeliveryAt,_that.deliveredAt,_that.restaurantId,_that.assignedDriverId,_that.orderType,_that.fulfillmentType,_that.restaurant,_that.coupon,_that.pickupAddress,_that.dropoffAddress,_that.requestedVehicleType,_that.requestedDeliveryType,_that.driver,_that.isManual,_that.driverDispatchDueAt,_that.driverDispatchDelayMinutes,_that.driverDispatchStatus,_that.driverDispatchRemainingSeconds,_that.driverDispatchServerTime,_that.driverDispatchMaxDelayMinutes,_that.supportsPreparationTiming,_that.preparationTimeMinutes,_that.preparationReadyAt,_that.preparationRemainingSeconds,_that.preparationServerTime,_that.preparationMaxMinutes,_that.driverDispatchLeadMinutes,_that.timingReceivedAt);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class _OrderModel implements OrderModel {
  const _OrderModel({required this.id, required this.customerName, required this.phoneNumber, required this.countryCode, required this.address, required final  List<OrderItemModel> items, this.subtotal = 0.0, this.deliveryFee = 0.0, this.discountAmount = 0.0, this.tips = 0.0, this.total = 0.0, this.sellerTotalAmount, this.isPaid = false, this.status = OrderStatusEnum.pending, this.hasAllowedStatusOptions = false, final  List<OrderAllowedStatusOption> allowedStatusOptions = const [], final  List<OrderAllowedAction> allowedActions = const [], this.notes, this.rejectionReason, required this.createdAt, this.acceptedAt, this.readyAt, this.outForDeliveryAt, this.deliveredAt, this.restaurantId, this.assignedDriverId, this.orderType = 'FOOD', this.fulfillmentType, this.restaurant, this.coupon, this.pickupAddress, this.dropoffAddress, this.requestedVehicleType, this.requestedDeliveryType, this.driver, this.isManual = false, this.driverDispatchDueAt, this.driverDispatchDelayMinutes, this.driverDispatchStatus, this.driverDispatchRemainingSeconds, this.driverDispatchServerTime, this.driverDispatchMaxDelayMinutes, this.supportsPreparationTiming = false, this.preparationTimeMinutes, this.preparationReadyAt, this.preparationRemainingSeconds, this.preparationServerTime, this.preparationMaxMinutes, this.driverDispatchLeadMinutes, this.timingReceivedAt}): _items = items,_allowedStatusOptions = allowedStatusOptions,_allowedActions = allowedActions;
...
@override final  double? sellerTotalAmount;
@override@JsonKey() final  bool isPaid;
@override@JsonKey() final  OrderStatusEnum status;
@override@JsonKey() final  bool hasAllowedStatusOptions;
 final  List<OrderAllowedStatusOption> _allowedStatusOptions;
@override@JsonKey() List<OrderAllowedStatusOption> get allowedStatusOptions {
  if (_allowedStatusOptions is EqualUnmodifiableListView) return _allowedStatusOptions;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_allowedStatusOptions);
}

 final  List<OrderAllowedAction> _allowedActions;
@override@JsonKey() List<OrderAllowedAction> get allowedActions {
...
@override final  String? fulfillmentType;
...
/// These remain nullable because older orders and orders that have not
/// been accepted yet do not have an active dispatch schedule.
@override final  DateTime? driverDispatchDueAt;
@override final  int? driverDispatchDelayMinutes;
@override final  String? driverDispatchStatus;
@override final  int? driverDispatchRemainingSeconds;
@override final  DateTime? driverDispatchServerTime;
@override final  int? driverDispatchMaxDelayMinutes;
@override@JsonKey() final  bool supportsPreparationTiming;
@override final  int? preparationTimeMinutes;
@override final  DateTime? preparationReadyAt;
@override final  int? preparationRemainingSeconds;
@override final  DateTime? preparationServerTime;
@override final  int? preparationMaxMinutes;
@override final  int? driverDispatchLeadMinutes;
/// Local receipt time for the server clock sample; survives widget remounts.
@override final  DateTime? timingReceivedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderModel&&(identical(other.id, id) || other.id == id)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.address, address) || other.address == address)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.discountAmount, discountAmount) || other.discountAmount == discountAmount)&&(identical(other.tips, tips) || other.tips == tips)&&(identical(other.total, total) || other.total == total)&&(identical(other.sellerTotalAmount, sellerTotalAmount) || other.sellerTotalAmount == sellerTotalAmount)&&(identical(other.isPaid, isPaid) || other.isPaid == isPaid)&&(identical(other.status, status) || other.status == status)&&(identical(other.hasAllowedStatusOptions, hasAllowedStatusOptions) || other.hasAllowedStatusOptions == hasAllowedStatusOptions)&&const DeepCollectionEquality().equals(other._allowedStatusOptions, _allowedStatusOptions)&&const DeepCollectionEquality().equals(other._allowedActions, _allowedActions)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.rejectionReason, rejectionReason) || other.rejectionReason == rejectionReason)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.acceptedAt, acceptedAt) || other.acceptedAt == acceptedAt)&&(identical(other.readyAt, readyAt) || other.readyAt == readyAt)&&(identical(other.outForDeliveryAt, outForDeliveryAt) || other.outForDeliveryAt == outForDeliveryAt)&&(identical(other.deliveredAt, deliveredAt) || other.deliveredAt == deliveredAt)&&(identical(other.restaurantId, restaurantId) || other.restaurantId == restaurantId)&&(identical(other.assignedDriverId, assignedDriverId) || other.assignedDriverId == assignedDriverId)&&(identical(other.orderType, orderType) || other.orderType == orderType)&&(identical(other.fulfillmentType, fulfillmentType) || other.fulfillmentType == fulfillmentType)&&(identical(other.restaurant, restaurant) || other.restaurant == restaurant)&&(identical(other.coupon, coupon) || other.coupon == coupon)&&(identical(other.pickupAddress, pickupAddress) || other.pickupAddress == pickupAddress)&&(identical(other.dropoffAddress, dropoffAddress) || other.dropoffAddress == dropoffAddress)&&(identical(other.requestedVehicleType, requestedVehicleType) || other.requestedVehicleType == requestedVehicleType)&&(identical(other.requestedDeliveryType, requestedDeliveryType) || other.requestedDeliveryType == requestedDeliveryType)&&(identical(other.driver, driver) || other.driver == driver)&&(identical(other.isManual, isManual) || other.isManual == isManual)&&(identical(other.driverDispatchDueAt, driverDispatchDueAt) || other.driverDispatchDueAt == driverDispatchDueAt)&&(identical(other.driverDispatchDelayMinutes, driverDispatchDelayMinutes) || other.driverDispatchDelayMinutes == driverDispatchDelayMinutes)&&(identical(other.driverDispatchStatus, driverDispatchStatus) || other.driverDispatchStatus == driverDispatchStatus)&&(identical(other.driverDispatchRemainingSeconds, driverDispatchRemainingSeconds) || other.driverDispatchRemainingSeconds == driverDispatchRemainingSeconds)&&(identical(other.driverDispatchServerTime, driverDispatchServerTime) || other.driverDispatchServerTime == driverDispatchServerTime)&&(identical(other.driverDispatchMaxDelayMinutes, driverDispatchMaxDelayMinutes) || other.driverDispatchMaxDelayMinutes == driverDispatchMaxDelayMinutes)&&(identical(other.supportsPreparationTiming, supportsPreparationTiming) || other.supportsPreparationTiming == supportsPreparationTiming)&&(identical(other.preparationTimeMinutes, preparationTimeMinutes) || other.preparationTimeMinutes == preparationTimeMinutes)&&(identical(other.preparationReadyAt, preparationReadyAt) || other.preparationReadyAt == preparationReadyAt)&&(identical(other.preparationRemainingSeconds, preparationRemainingSeconds) || other.preparationRemainingSeconds == preparationRemainingSeconds)&&(identical(other.preparationServerTime, preparationServerTime) || other.preparationServerTime == preparationServerTime)&&(identical(other.preparationMaxMinutes, preparationMaxMinutes) || other.preparationMaxMinutes == preparationMaxMinutes)&&(identical(other.driverDispatchLeadMinutes, driverDispatchLeadMinutes) || other.driverDispatchLeadMinutes == driverDispatchLeadMinutes)&&(identical(other.timingReceivedAt, timingReceivedAt) || other.timingReceivedAt == timingReceivedAt));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,customerName,phoneNumber,countryCode,address,const DeepCollectionEquality().hash(_items),subtotal,deliveryFee,discountAmount,tips,total,sellerTotalAmount,isPaid,status,hasAllowedStatusOptions,const DeepCollectionEquality().hash(_allowedStatusOptions),const DeepCollectionEquality().hash(_allowedActions),notes,rejectionReason,createdAt,acceptedAt,readyAt,outForDeliveryAt,deliveredAt,restaurantId,assignedDriverId,orderType,fulfillmentType,restaurant,coupon,pickupAddress,dropoffAddress,requestedVehicleType,requestedDeliveryType,driver,isManual,driverDispatchDueAt,driverDispatchDelayMinutes,driverDispatchStatus,driverDispatchRemainingSeconds,driverDispatchServerTime,driverDispatchMaxDelayMinutes,supportsPreparationTiming,preparationTimeMinutes,preparationReadyAt,preparationRemainingSeconds,preparationServerTime,preparationMaxMinutes,driverDispatchLeadMinutes,timingReceivedAt]);
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? customerName = null,Object? phoneNumber = null,Object? countryCode = null,Object? address = null,Object? items = null,Object? subtotal = null,Object? deliveryFee = null,Object? discountAmount = null,Object? tips = null,Object? total = null,Object? sellerTotalAmount = freezed,Object? isPaid = null,Object? status = null,Object? hasAllowedStatusOptions = null,Object? allowedStatusOptions = null,Object? allowedActions = null,Object? notes = freezed,Object? rejectionReason = freezed,Object? createdAt = null,Object? acceptedAt = freezed,Object? readyAt = freezed,Object? outForDeliveryAt = freezed,Object? deliveredAt = freezed,Object? restaurantId = freezed,Object? assignedDriverId = freezed,Object? orderType = null,Object? fulfillmentType = freezed,Object? restaurant = freezed,Object? coupon = freezed,Object? pickupAddress = freezed,Object? dropoffAddress = freezed,Object? requestedVehicleType = freezed,Object? requestedDeliveryType = freezed,Object? driver = freezed,Object? isManual = null,Object? driverDispatchDueAt = freezed,Object? driverDispatchDelayMinutes = freezed,Object? driverDispatchStatus = freezed,Object? driverDispatchRemainingSeconds = freezed,Object? driverDispatchServerTime = freezed,Object? driverDispatchMaxDelayMinutes = freezed,Object? supportsPreparationTiming = null,Object? preparationTimeMinutes = freezed,Object? preparationReadyAt = freezed,Object? preparationRemainingSeconds = freezed,Object? preparationServerTime = freezed,Object? preparationMaxMinutes = freezed,Object? driverDispatchLeadMinutes = freezed,Object? timingReceivedAt = freezed,}) {
...
as bool,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as OrderStatusEnum,hasAllowedStatusOptions: null == hasAllowedStatusOptions ? _self.hasAllowedStatusOptions : hasAllowedStatusOptions // ignore: cast_nullable_to_non_nullable
as bool,allowedStatusOptions: null == allowedStatusOptions ? _self._allowedStatusOptions : allowedStatusOptions // ignore: cast_nullable_to_non_nullable
as List<OrderAllowedStatusOption>,allowedActions: null == allowedActions ? _self._allowedActions : allowedActions // ignore: cast_nullable_to_non_nullable
as List<OrderAllowedAction>,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
as String?,rejectionReason: freezed == rejectionReason ? _self.rejectionReason : rejectionReason // ignore: cast_nullable_to_non_nullable
as String?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,acceptedAt: freezed == acceptedAt ? _self.acceptedAt : acceptedAt // ignore: cast_nullable_to_non_nullable
