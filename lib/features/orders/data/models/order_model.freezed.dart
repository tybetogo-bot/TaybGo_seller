...
@override
int get hashCode => Object.hashAll([runtimeType,id,customerName,phoneNumber,countryCode,address,const DeepCollectionEquality().hash(items),subtotal,deliveryFee,discountAmount,tips,total,isPaid,status,hasAllowedStatusOptions,const DeepCollectionEquality().hash(allowedStatusOptions),notes,rejectionReason,createdAt,acceptedAt,readyAt,outForDeliveryAt,deliveredAt,restaurantId,assignedDriverId,orderType,restaurant,coupon,pickupAddress,dropoffAddress,requestedVehicleType,requestedDeliveryType,driver,isManual]);

@override
String toString() {
  return 'OrderModel(id: $id, customerName: $customerName, phoneNumber: $phoneNumber, countryCode: $countryCode, address: $address, items: $items, subtotal: $subtotal, deliveryFee: $deliveryFee, discountAmount: $discountAmount, tips: $tips, total: $total, isPaid: $isPaid, status: $status, hasAllowedStatusOptions: $hasAllowedStatusOptions, allowedStatusOptions: $allowedStatusOptions, notes: $notes, rejectionReason: $rejectionReason, createdAt: $createdAt, acceptedAt: $acceptedAt, readyAt: $readyAt, outForDeliveryAt: $outForDeliveryAt, deliveredAt: $deliveredAt, restaurantId: $restaurantId, assignedDriverId: $assignedDriverId, orderType: $orderType, restaurant: $restaurant, coupon: $coupon, pickupAddress: $pickupAddress, dropoffAddress: $dropoffAddress, requestedVehicleType: $requestedVehicleType, requestedDeliveryType: $requestedDeliveryType, driver: $driver, isManual: $isManual)';
}
...
@useResult
$Res call({
 String id, String customerName, String phoneNumber, String countryCode, AddressModel address, List<OrderItemModel> items, double subtotal, double deliveryFee, double discountAmount, double tips, double total, bool isPaid, OrderStatusEnum status, bool hasAllowedStatusOptions, List<OrderAllowedStatusOption> allowedStatusOptions, String? notes, String? rejectionReason, DateTime createdAt, DateTime? acceptedAt, DateTime? readyAt, DateTime? outForDeliveryAt, DateTime? deliveredAt, String? restaurantId, String? assignedDriverId, String orderType, OrderRestaurantModel? restaurant, OrderCouponModel? coupon, OrderAddressModel? pickupAddress, OrderAddressModel? dropoffAddress, String? requestedVehicleType, String? requestedDeliveryType, OrderDriverModel? driver, bool isManual
});
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? customerName = null,Object? phoneNumber = null,Object? countryCode = null,Object? address = null,Object? items = null,Object? subtotal = null,Object? deliveryFee = null,Object? discountAmount = null,Object? tips = null,Object? total = null,Object? isPaid = null,Object? status = null,Object? hasAllowedStatusOptions = null,Object? allowedStatusOptions = null,Object? notes = freezed,Object? rejectionReason = freezed,Object? createdAt = null,Object? acceptedAt = freezed,Object? readyAt = freezed,Object? outForDeliveryAt = freezed,Object? deliveredAt = freezed,Object? restaurantId = freezed,Object? assignedDriverId = freezed,Object? orderType = null,Object? restaurant = freezed,Object? coupon = freezed,Object? pickupAddress = freezed,Object? dropoffAddress = freezed,Object? requestedVehicleType = freezed,Object? requestedDeliveryType = freezed,Object? driver = freezed,Object? isManual = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as List<OrderAllowedStatusOption>,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String customerName,  String phoneNumber,  String countryCode,  AddressModel address,  List<OrderItemModel> items,  double subtotal,  double deliveryFee,  double discountAmount,  double tips,  double total,  bool isPaid,  OrderStatusEnum status,  bool hasAllowedStatusOptions,  List<OrderAllowedStatusOption> allowedStatusOptions,  String? notes,  String? rejectionReason,  DateTime createdAt,  DateTime? acceptedAt,  DateTime? readyAt,  DateTime? outForDeliveryAt,  DateTime? deliveredAt,  String? restaurantId,  String? assignedDriverId,  String orderType,  OrderRestaurantModel? restaurant,  OrderCouponModel? coupon,  OrderAddressModel? pickupAddress,  OrderAddressModel? dropoffAddress,  String? requestedVehicleType,  String? requestedDeliveryType,  OrderDriverModel? driver,  bool isManual)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
return $default(_that.id,_that.customerName,_that.phoneNumber,_that.countryCode,_that.address,_that.items,_that.subtotal,_that.deliveryFee,_that.discountAmount,_that.tips,_that.total,_that.isPaid,_that.status,_that.hasAllowedStatusOptions,_that.allowedStatusOptions,_that.notes,_that.rejectionReason,_that.createdAt,_that.acceptedAt,_that.readyAt,_that.outForDeliveryAt,_that.deliveredAt,_that.restaurantId,_that.assignedDriverId,_that.orderType,_that.restaurant,_that.coupon,_that.pickupAddress,_that.dropoffAddress,_that.requestedVehicleType,_that.requestedDeliveryType,_that.driver,_that.isManual);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String customerName,  String phoneNumber,  String countryCode,  AddressModel address,  List<OrderItemModel> items,  double subtotal,  double deliveryFee,  double discountAmount,  double tips,  double total,  bool isPaid,  OrderStatusEnum status,  bool hasAllowedStatusOptions,  List<OrderAllowedStatusOption> allowedStatusOptions,  String? notes,  String? rejectionReason,  DateTime createdAt,  DateTime? acceptedAt,  DateTime? readyAt,  DateTime? outForDeliveryAt,  DateTime? deliveredAt,  String? restaurantId,  String? assignedDriverId,  String orderType,  OrderRestaurantModel? restaurant,  OrderCouponModel? coupon,  OrderAddressModel? pickupAddress,  OrderAddressModel? dropoffAddress,  String? requestedVehicleType,  String? requestedDeliveryType,  OrderDriverModel? driver,  bool isManual)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
return $default(_that.id,_that.customerName,_that.phoneNumber,_that.countryCode,_that.address,_that.items,_that.subtotal,_that.deliveryFee,_that.discountAmount,_that.tips,_that.total,_that.isPaid,_that.status,_that.hasAllowedStatusOptions,_that.allowedStatusOptions,_that.notes,_that.rejectionReason,_that.createdAt,_that.acceptedAt,_that.readyAt,_that.outForDeliveryAt,_that.deliveredAt,_that.restaurantId,_that.assignedDriverId,_that.orderType,_that.restaurant,_that.coupon,_that.pickupAddress,_that.dropoffAddress,_that.requestedVehicleType,_that.requestedDeliveryType,_that.driver,_that.isManual);}
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _OrderModel&&(identical(other.id, id) || other.id == id)&&(identical(other.customerName, customerName) || other.customerName == customerName)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&(identical(other.address, address) || other.address == address)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.discountAmount, discountAmount) || other.discountAmount == discountAmount)&&(identical(other.tips, tips) || other.tips == tips)&&(identical(other.total, total) || other.total == total)&&(identical(other.isPaid, isPaid) || other.isPaid == isPaid)&&(identical(other.status, status) || other.status == status)&&(identical(other.hasAllowedStatusOptions, hasAllowedStatusOptions) || other.hasAllowedStatusOptions == hasAllowedStatusOptions)&&const DeepCollectionEquality().equals(other._allowedStatusOptions, _allowedStatusOptions)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.rejectionReason, rejectionReason) || other.rejectionReason == rejectionReason)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.acceptedAt, acceptedAt) || other.acceptedAt == acceptedAt)&&(identical(other.readyAt, readyAt) || other.readyAt == readyAt)&&(identical(other.outForDeliveryAt, outForDeliveryAt) || other.outForDeliveryAt == outForDeliveryAt)&&(identical(other.deliveredAt, deliveredAt) || other.deliveredAt == deliveredAt)&&(identical(other.restaurantId, restaurantId) || other.restaurantId == restaurantId)&&(identical(other.assignedDriverId, assignedDriverId) || other.assignedDriverId == assignedDriverId)&&(identical(other.orderType, orderType) || other.orderType == orderType)&&(identical(other.restaurant, restaurant) || other.restaurant == restaurant)&&(identical(other.coupon, coupon) || other.coupon == coupon)&&(identical(other.pickupAddress, pickupAddress) || other.pickupAddress == pickupAddress)&&(identical(other.dropoffAddress, dropoffAddress) || other.dropoffAddress == dropoffAddress)&&(identical(other.requestedVehicleType, requestedVehicleType) || other.requestedVehicleType == requestedVehicleType)&&(identical(other.requestedDeliveryType, requestedDeliveryType) || other.requestedDeliveryType == requestedDeliveryType)&&(identical(other.driver, driver) || other.driver == driver)&&(identical(other.isManual, isManual) || other.isManual == isManual));
}


@override
int get hashCode => Object.hashAll([runtimeType,id,customerName,phoneNumber,countryCode,address,const DeepCollectionEquality().hash(_items),subtotal,deliveryFee,discountAmount,tips,total,isPaid,status,hasAllowedStatusOptions,const DeepCollectionEquality().hash(_allowedStatusOptions),notes,rejectionReason,createdAt,acceptedAt,readyAt,outForDeliveryAt,deliveredAt,restaurantId,assignedDriverId,orderType,restaurant,coupon,pickupAddress,dropoffAddress,requestedVehicleType,requestedDeliveryType,driver,isManual]);
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? customerName = null,Object? phoneNumber = null,Object? countryCode = null,Object? address = null,Object? items = null,Object? subtotal = null,Object? deliveryFee = null,Object? discountAmount = null,Object? tips = null,Object? total = null,Object? isPaid = null,Object? status = null,Object? hasAllowedStatusOptions = null,Object? allowedStatusOptions = null,Object? notes = freezed,Object? rejectionReason = freezed,Object? createdAt = null,Object? acceptedAt = freezed,Object? readyAt = freezed,Object? outForDeliveryAt = freezed,Object? deliveredAt = freezed,Object? restaurantId = freezed,Object? assignedDriverId = freezed,Object? orderType = null,Object? restaurant = freezed,Object? coupon = freezed,Object? pickupAddress = freezed,Object? dropoffAddress = freezed,Object? requestedVehicleType = freezed,Object? requestedDeliveryType = freezed,Object? driver = freezed,Object? isManual = null,}) {
