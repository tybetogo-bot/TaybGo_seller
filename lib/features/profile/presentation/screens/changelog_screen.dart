  ...
  static const _releases = [
    _ReleaseNotes(
      ...
      changeKeys: [
        ...
        'changelog.v1019.change3',
        'changelog.v1019.change4',
      ],
    ),
    _ReleaseNotes(
      version: '1.0.18+20',
      dateKey: 'changelog.v1018.date',
      changeKeys: [
        'changelog.v1018.change1',
        'changelog.v1018.change2',
        'changelog.v1018.change3',
        'changelog.v1018.change4',
        'changelog.v1018.change5',
        'changelog.v1018.change6',
        'changelog.v1018.change7',
        'changelog.v1018.change8',
        'changelog.v1018.change9',
        'changelog.v1018.change10',
        'changelog.v1018.change11',
        'changelog.v1018.change12',
      ],
    ),
    _ReleaseNotes(
      version: '1.0.16+17',
      dateKey: 'changelog.v1016.date',
      changeKeys: [
        'changelog.v1016.change1',
        'changelog.v1016.change2',
        'changelog.v1016.change3',
      ],
    ),
    _ReleaseNotes(
      version: '1.0.15+16',
      dateKey: 'changelog.v1015.date',
      changeKeys: [
        'changelog.v1015.change1',
        'changelog.v1015.change2',
        'changelog.v1015.change3',
        'changelog.v1015.change4',
      ],
    ),
    _ReleaseNotes(
      version: '1.0.14+15',
